document.addEventListener("DOMContentLoaded", function() {
    ...
    function typeWriter(element, text, i, fnCallback) {
        if (i < text.length) {
            ...
            }, 50); // Reduzi o tempo para 90ms para aumentar a velocidade
...
document.addEventListener("DOMContentLoaded", function() {
    const linguagens = {
        ...
        sqlserver: "SQL Server não é uma linguagem de programação, mas sim um sistema de gerenciamento de banco de dados desenvolvido pela Microsoft. É usado para armazenar e gerenciar grandes volumes de dados de forma eficiente e segura. Imagine como um arquivo gigante onde podemos guardar informações de maneira organizada, como dados de clientes, produtos ou transações. Ele permite que aplicativos e sites acessem esses dados rapidamente, fazendo consultas e atualizações conforme necessário.",
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function typeWriterLanges(element, text, i, fnCallback) {
        if (i < text.length) {
            ...
            }, 200); // Reduzi o tempo para 90ms para aumentar a velocidade
        } else if (typeof fnCallback == 'function') {
            setTimeout(fnCallback, 700);
        }
    }
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function typeWriterLanges(element, text, i, fnCallback) {
        if (i < text.length) {
            ...
            setTimeout(function() {
                typeWriterLanges(element, text, i + 1, fnCallback)
            }, 350); // Reduzi o tempo para 90ms para aumentar a velocidade
        } else if (typeof fnCallback == 'function') {
            setTimeout(fnCallback, 700);
        }
    }
